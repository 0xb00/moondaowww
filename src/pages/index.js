...
async function fetchAndUpdateProgress() {
  ...
  document.getElementById('moneyAmounts').textContent =
    '$' + usdReadable + '  (' + ethReadable + ' ETH)';
  document.getElementById('goalAmounts').textContent =
    '$' + targetUSDreadble + '   (' + ethGoal + ' ETH)';
  document.getElementById('goalAmountsMobile').textContent =
    '$' + targetUSDreadble + '   (' + ethGoal + ' ETH)';
}
...
function runCountdown() {
  ...
  var timerInterval = setInterval(() => {
    ...
    if (screen.width < 1000) {
      document.getElementById('base-timer-label-days-m').innerHTML =
        String(daysRemainingDisplay) + ' D';
      document.getElementById('base-timer-label-hours-m').innerHTML =
        String(hoursRemaining) + ' H';
      document.getElementById('base-timer-label-minutes-m').innerHTML =
        String(minutesRemaining) + ' M';
      document.getElementById('base-timer-label-seconds-m').innerHTML =
          ...
          <div className="BigHero">
            <div className="Block__Contents" id="homeTitle">
              ...
              <div id="timerContainerMobile">
                <span
                  id="base-timer-label-days-m"
                  class="mobile-countdown-digit"></span>
                <span
                  id="base-timer-label-hours-m"
                  class="mobile-countdown-digit"></span>
                <span
                  id="base-timer-label-minutes-m"
                  class="mobile-countdown-digit"></span>
                <span
                  id="base-timer-label-seconds-m"
                  class="mobile-countdown-digit"></span>
              </div>
              ...
              <h1 className="daoColor" id="endRaise"></h1>
          ...
          <div className="Block__Contents">
            <div className="Row">
              <div className="Column--100">
                ...
                <ol>
                  <li>
                    Offer <a href="/docs/token">$MOONEY governance tokens</a> to
                    begin decentralized community governance of MoonDAO.{' '}
                    <strong> This will be our only supply of tokens.</strong>
                  </li>
                  <li>
                    Release the <strong>Ticket to Space</strong> NFT collection.
                    These NFTs will give you a chance to fly to space in 2022.
                  </li>
                  <li>
          ...
          <div className="Block__Contents">
            <div className="Row">
              <div className="Column--100">
                ...
                <h2>MoonDAO is going to the moon.</h2>
                <p>
        ...
        <div className="Values Block">
          <div className="Block__Contents">
            <div className="Row">
              <div className="Column--100">
                <h5>Values</h5>
                <h3>Space should be in the hands of the people.</h3>
                <p>
          ...
          <div className="Block__Contents">
            ...
            <div className="Row AlignCenter">
              <div className="Column--66">
                ...
                <p className="small">
                  In order to be a DAO, we need a governance token for decision
                  making. Launching the{' '}
                  <a href="/docs/token">$MOONEY governance token</a> is our
